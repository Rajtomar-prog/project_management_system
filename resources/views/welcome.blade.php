...
<head>
    ...
    <title>{{ config('app.name', 'Jarvis') }} | A Project Management System</title>
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="{{ url('/') }}">Jarvis</a></h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <h1>Better Solutions For Managing Projects</h1>
                    <h2>We are team of talented designers & developes making your project world class</h2>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <p>
                            Welcome to Jarvis | CRM, your trusted partner in streamlining and
                            optimizing project management processes. Our mission is to empower individuals and teams
                            with the tools they need to plan, execute, and succeed in their projects with precision and
                            efficiency.
                        </p>
                        <h5>Why Choose Us?</h5>
                        <ul>
                            <li><i class="ri-check-double-line"></i> <strong>Approach:</strong> We prioritize your
                                needs.
                                Our user-friendly interface and intuitive features ensure that both seasoned project
                                managers and newcomers find our system easy to navigate and utilize.</li>
                            <li><i class="ri-check-double-line"></i> <strong>Solution:</strong> From initial planning
                                to
                                final delivery, our project management system covers the entire spectrum of project
                                phases. With modules for task management, resource allocation, scheduling, and
                                reporting, we've got you covered.</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <h5>Our Vision</h5>
                        <p>
                            At Jarvis | CRM, we envision a world where project management is seamless, transparent, and
                            highly effective. Our vision is to be the driving force behind project success stories,
                            enabling businesses to deliver results beyond expectations while fostering innovation and
                            growth.
                        </p>
                        <p>
                            With years of experience in the industry, we understand the challenges that come with
                            managing projects of all sizes. That's why we've developed a comprehensive project
                            management system that is designed to simplify complexity and enhance collaboration at every
        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Services</h2>
                    <p>Our Project Management System offers a comprehensive range of services tailored to meet the
                        diverse needs of project managers, teams, and organizations. With a focus on enhancing
                        collaboration, efficiency, and project success, our services include:</p>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Task and Activity Management</a></h4>
                            <p>Easily create, assign, and track tasks and activities within your projects. Monitor
                                progress, set priorities, and ensure timely completion.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Project Planning and Scheduling</a></h4>
                            <p>Develop detailed project plans, define milestones, allocate resources, and create
                                realistic schedules. Visualize project timelines and dependencies for better
                                decision-making.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Resource Allocation and Management</a></h4>
                            <p>Efficiently assign resources based on availability, skills, and workload. Avoid resource
                                conflicts and optimize resource utilization to ensure project efficiency.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="">Collaboration and Communication</a></h4>
                            <p>Foster seamless communication and collaboration among team members. Share files, hold
                                discussions, and provide real-time updates to ensure everyone is aligned.</p>
                        </div>
                    </div>
    ...
    <footer id="footer">
        ...
        <div class="container footer-bottom clearfix">
            <div class="copyright">
                &copy; {{ date('Y') }} <strong><span>{{ config('app.name', 'Jarvis') }}</span></strong>. All
                Rights Reserved

            </div>
            <div class="credits">
                Designed by <a href="https://twscorp.in">TWS Corp.</a>
            </div>
        </div>
    </footer><!-- End Footer -->
